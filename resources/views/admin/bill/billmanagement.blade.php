...
<body>
    ...
    <div class="main-content">
        ...
        <div class="filters">
            <form method="GET" action="{{ route('admin.billManager') }}" class="filter-form">
                
                <div class="search-box">
                    <input type="text" name="search" placeholder="🔍 Tìm hóa đơn" value="{{ request('search') }}">
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btns">
                                        <a href="{{route('admin.detail', $bill->MaHD)}}" class="btn-sm btn-edit"><b>Chi tiết</b></a>
                                        
                                        <form action="{{route('admin.bill.toggle', $bill->MaHD)}}" method="POST" style="display: inline;">
                                            @csrf
                ...
                @if($bills->hasPages())
                    <div class="pagination-wrapper">
                        <div class="pagination-info">
                            Hiển thị {{ $bills->firstItem() }} - {{ $bills->lastItem() }} 
                            trong tổng số {{ $bills->total() }} sản phẩm
                        </div>
                        ...
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-prev">
                                    <a href="{{ $bills->previousPageUrl() }}" rel="prev">← Trước</a>
                                </li>
                            @endif
                            ...
                            @if ($bills->hasMorePages())
                                <li class="page-next">
                                    <a href="{{ $bills->nextPageUrl() }}" rel="next">Sau →</a>
                                </li>
                            @else
                                <li class="disabled">
                                    <span>Sau →</span>
